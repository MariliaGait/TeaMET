...
if (qprogram==1) {
 ...
 String result2 = diadiktiaka+ ", " + prog + ", " + mark + ", " + adv;
  // τα ενδιαφέροντα του χρήστη θα συγκεντρώνονταν στα result1 και result2 (θα συλλέγονταν και τα αντίστοιχα δεδομένα από το αρχικό login button), τα οποία θα στέλνονταν στο AI για τη συνέχεια της διαδικασίας, και τη πρόταση των κατάλληλων εθελοντικών δράσεων στον χρήστη
